...
INTERFACE     EQU   $38                   ; Two line display
...
LINE_VARIANCE           FCB   $18           ; Variance based on testing to 
...
FWD_ST            BRSET   PORTAD0, $04, NO_FWD_BUMP           ; If the bow bumper is hit                           
                  MOVB    #REV_TRN, CRNT_STATE                ; put it in the                                  
                                                              ; REV_TURN state                             
...
NO_FWD_BUMP       BRSET   PORTAD0, $04, NO_FWD_REAR_BUMP      ; Checks if the stern bumper is hit 
                  MOVB    #ALL_STOP, CRNT_STATE               ; if true, put it in the                   
